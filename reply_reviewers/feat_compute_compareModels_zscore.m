...
out_feat_path          = '/remotedata/AgGross/TBraiC/MV-eye/STRG_computed_features/rev_reply_MEG_zscore';
...
parfor isubj = 1:nsubjs
    ...
    for icond = 1:2
        ...
        % zscore data at single trial level
        dat.trial = cellfun(@(x) zscore(x, [], 2), dat.trial, 'UniformOutput',false);
