...
#%% concatenate subjects but while concurrently splitting training and test
# SAME OPERATION AS THE PREVIOUS FUNCTION, but without implementic a scaler
# within subjects

def cat_subjs_train_test_NOSCALE(infold, best_feats=None, subjlist=None, strtsubj=None, 
                                 endsubj=None, ftype='feats', tanh_flag=False, 
                                 compress_flag=False, test_size=.15, pca_kept_var=None):
