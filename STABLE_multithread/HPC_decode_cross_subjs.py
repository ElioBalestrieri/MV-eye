...
for iBPcond in freqbands:
    ...
    # generate datasets
    full_train_X, full_train_Y = cat_subjs(infold, strtsubj=0, endsubj=22, ftype=iBPcond)
    full_test_X, full_test_Y = cat_subjs(infold, strtsubj=22, endsubj=29, ftype=iBPcond)
