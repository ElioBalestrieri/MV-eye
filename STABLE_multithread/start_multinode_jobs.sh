...
#SBATCH --nodes=7                   # the number of nodes you want to reserve
...
#SBATCH --job-name=decodeParcels    # the name of your job
...
FREQBANDS=$(sed -n $SLURM_ARRAY_TASK_ID'p' freqbands_shlauncher.csv | cut -d ',' -f2)

# START THE APPLICATION
python HPC_parallel_parcel_classification.py $FREQBANDS
