...
# save out
foutname_trainX = outfold + 'SeqFeatSel_condscollapsed_trainX.csv'
foutname_testX = outfold + 'SeqFeatSel_condscollapsed_testX.csv'
foutname_trainY = outfold + 'SeqFeatSel_condscollapsed_trainY.csv'
foutname_testY = outfold + 'SeqFeatSel_condscollapsed_testY.csv'
...
accs_DF = pd.DataFrame(data=list_accs, index=['accuracy_4conds'])
accs_DF.to_csv(outfold + 'SeqFeatSel_overall_test_accuracy_condscollapsed.csv')
