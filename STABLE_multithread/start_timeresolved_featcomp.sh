...
#SBATCH --cpus-per-task=15         # the number cpus per task
...
#SBATCH --job-name=timeResolvedFeatures    # the name of your job
...
matlab -nodisplay -nosplash -nodesktop -r "HPC_timeresolved_feats(15); exit;"
