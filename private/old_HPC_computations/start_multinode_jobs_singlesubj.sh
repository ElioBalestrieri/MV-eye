...
#SBATCH --nodes=5                   # the number of nodes you want to reserve
...
#SBATCH --job-name=LEMONwithin_subj    # the name of your job
...
EXPCONDS=$(sed -n $SLURM_ARRAY_TASK_ID'p' mdltypes_shlauncher.csv | cut -d ',' -f2)

# START THE APPLICATION
python HPC_withinsubjs_mdl_compare_LEMON.py $EXPCONDS
